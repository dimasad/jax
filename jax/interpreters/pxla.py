...
# TODO(jblespiau): Remove this constant when the change has landed without
# issues.
_USE_EXPERIMENTAL_CPP_SDA = True
...
def make_sharded_device_array(
  ...
  if (_xla_extension_version >= 31 and _USE_EXPERIMENTAL_CPP_SDA and
...
class _ShardedDeviceArray(base_class):  # type: ignore
  ...
  def __init__(
    ...
    if _xla_extension_version >= 31:
      ShardedDeviceArrayBase.__init__(self)
...
if _xla_extension_version >= 31 and _USE_EXPERIMENTAL_CPP_SDA:
